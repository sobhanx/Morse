"""Multi-tenant helpers: website ContextVar + abstract TenantModel."""
...
class TenantModel(models.Model):
    # app_label of Website remains "websites" while model source lives under morse/
    # (preserves migration history without table renames).
